...
btnLogin.setOnClickListener(new View.OnClickListener() {
    ...
    */
    public void user(){
        ...
        Query checkUserValid = FirebaseDatabase.getInstance().getReference("teacher_users").orderByChild("uname").equalTo(userName);
        ...
        checkUserValid.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(TeacherLogin.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}